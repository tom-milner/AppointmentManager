...
var Processor =
  ...
  (function() {
    ...
    _proto.add = function add(css, result) {
      ...
      var gridPrefixes =
        this.gridStatus(css, result) && this.prefixes.add["grid-area"] && this.prefixes.add["grid-area"].prefixes;
      ...
      return css.walkDecls(function(decl) {
        ...
        for (
          var _iterator3 = _this.prefixes.values("add", unprefixed),
    ...
    _proto.remove = function remove(css, result) {
      ...
      for (
        var _iterator4 = this.prefixes.remove.selectors,
      ...
      return css.walkDecls(function(decl, i) {
        ...
        for (
          var _iterator5 = _this2.prefixes.values("remove", unprefixed),
    ...
    _proto.displayType = function displayType(decl) {
      for (
        var _iterator6 = decl.parent.nodes,
