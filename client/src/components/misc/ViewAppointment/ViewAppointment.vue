        ...
        <div class="wrapper">
            ...
            <ul class="appointment-details">
                ...
                <li v-if="appointment.appointmentType.isRecurring" class="appointment-details-row">
                    ...
                    <h4 class="heading-4">
                        {{ appointment.recurringNo + 1 }} /
                        {{ appointment.appointmentType.recurringDuration }} appointments
                    </h4>
                </li>
            ...
            <Dialogue @close-dialogue="showDeleteDialogue = false" v-if="showDeleteDialogue">
                <div class="delete-dialogue-content">
                    ...
                    <div class="dialogue-buttons">
                        <button class="btn btn-disapproved" @click="deleteAppointment(false)">
...
export default {
    ...
    methods: {
        async deleteAppointment(deleteRecurring) {
            // send delete request
            try {
                await AppointmentService.deleteAppointment(this.appointment._id, deleteRecurring);
        ...
        saveNotes(areCounsellorNotes) {
            ...
            try {
                AppointmentService.updateAppointment(appointmentProperties, appointmentId);
            } catch (error) {
                console.log(error);
            }
        },
